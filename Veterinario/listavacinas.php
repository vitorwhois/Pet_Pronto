...
$idVacina = isset($_GET['id']) ? $_GET['id'] : null;
...
// Verifica se o ID da vacina é válido
if (!is_numeric($idVacina) || $idVacina <= 0) {
    echo "<p>ID da vacina inválido.</p>";
    exit;
}
...
<div class="row mt-3">
    ...
    <section>
        <main class="container pt-0">
            <div class="card mb-0">
                <div class="card-header text-center"><h1>Vacinas</h1></div>
...
?>
        ...
        <div class="row">
            <div class="col-xl-11 col-md-8 col-sm-8 mx-auto py-0 ">
                    </div>
...
while ($row = $result->fetch_assoc()) {
    echo "<tr>";
    echo "<td>" . $row['titulo_vacina'] . "</td>";
    echo "<td>" . $row['data_aplicacao'] . "</td>";
    echo "<td>" . $row['proxima_dose'] . "</td>";
    // Altere a linha abaixo para passar o id_aplicacao_vacina em vez do id do pet
    echo "<td><a href='vervacina.php?id_pet=" . $idPet . "&id_aplicacao_vacina=" . $row['id_aplicacao_vacina'] . "' class='btn btn-primary'>Ver</a></td>";
...
?>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="4">
                                            <?php if (!empty($idPet)) : ?>
        <a href="formulariovacina.php?id_pet=<?= $idPet ?>" class="btn btn-primary mb-2">Iniciar Atendimento</a>
    <?php endif; ?>
